...
<nav class="navbar navbar-default ">
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="#">Electricistas</a>
    </div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        ...
        <li class="<?php if (isset($active_talle)){echo $active_talle;}?>"><a href="talles.php"><i class='glyphicon glyphicon-tags'></i> Talles</a></li>
      ...
      <ul class="nav navbar-nav navbar-right">
        <li><a href="https://www.new16111987.mipropia.com" target='_blank'><i class='glyphicon glyphicon-envelope'></i> Soporte</a></li>
