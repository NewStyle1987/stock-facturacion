...
<html lang="en">
  ...
  <body>
	...
	if(empty($row['img'])){
	$img='https://estaticos.muyinteresante.es/media/cache/760x570_thumb/uploads/images/article/59d4b0ae5bafe8824b5c70e2/lisozima_0.jpg';
	}else{
	$img=$row['img'];
	}
